...
def cross_floor(start, end, time, wind_h, wind_v, size_x, size_y):

    # search
    states = deque([(start, time)])
    best_time = 9999999
    seen = set()
...
def solve(floor):
    ...
    time = 1
    first_time = cross_floor(start, end, time, wind_h, wind_v, size_x, size_y)

    # tenemos que vorve... que se ma caio el carne!
    second_time = cross_floor(end, start, first_time - 1, wind_h, wind_v, size_x, size_y)

    # nooo! que hase mah frio que en verano!
    third_time = cross_floor(start, end, second_time - 1, wind_h, wind_v, size_x, size_y)
